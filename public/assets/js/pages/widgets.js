...
var KTWidgets = (function () {
  ...
  var _initMyprofiles = function () {
    ...
    var options = {
      series: [
        {
          name: chartSettings.profile.name,
          data: chartSettings.profile.data,
        },
      ],
      chart: {
        type: "area",
      ...
      xaxis: {
        categories: chartSettings.profile.categories,
        axisBorder: {
          show: false,
        },
        axisTicks: {
  ...
  var _initMyUsers = function () {
    ...
    var options = {
      series: [
        {
          name: chartSettings.users.name,
          data: chartSettings.users.data,
        },
      ],
      chart: {
        type: "area",
      ...
      xaxis: {
        categories:chartSettings.users.categories,
        axisBorder: {
          show: false,
        },
        axisTicks: {
  ...
  var _initAnalytics = function () {
    ...
    var options = {
      series: [
        {
          name: chartSettings.analytics.name,
          data: chartSettings.analytics.data,
        },
      ],
      chart: {
        type: "area",
      ...
      xaxis: {
        categories: chartSettings.analytics.categories,
        axisBorder: {
          show: false,
        },
        axisTicks: {
