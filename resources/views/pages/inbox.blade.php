                                            ...
                                            <table class="table table-head-custom table-vertical-center">
                                                ...
                                                <tbody>
                                                    @foreach ($profiles as $item)
                                                        ...
                                                        <div class="modal fade" id="final_documents{{ $item->id }}" tabindex="-1"
                                                            role="dialog" aria-labelledby="final" aria-hidden="true">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="scanned_document4"
                                                                                        id="scanned_document4" type="file"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="scanned_document5"
                                                                                        id="scanned_document5" type="file"
                                                                                        class="form-control form-control-solid"
                                                                                        placeholder="Name" />
                                                                                </div>
                                                                                @else
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="scanned_document6"
                                                                                        id="scanned_document6" type="file"
                                                                                        class="form-control form-control-solid"
                                                                                        placeholder="Name" />
                                                                                </div>
                                                                                @else
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="scanned_document7"
                                                                                        id="scanned_document7" type="file"
                                                                                        class="form-control form-control-solid"
                                                                                        placeholder="Name" />
                                                                                </div>
                                                                                @else
                                                    ...
                                                    <form action="{{ url('profile/document/update', $item->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <label>Doc 1</label>
                                                                    <input type="text" id="editingid" name="editingid"
                                                                        hidden>
                                                                    <input name="scanned_document4" id="scanned_document4"
                                                                        type="file" class="form-control form-control-solid"
                                                                        placeholder="Name" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Doc 2</label>
                                                                    <input name="scanned_document5" id="scanned_document5"
                                                                        type="file" class="form-control form-control-solid"
                                                                        placeholder="Name" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Doc 3</label>
                                                                    <input name="scanned_document6" id="scanned_document6"
                                                                        type="file" class="form-control form-control-solid"
                                                                        placeholder="Name" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Doc 4</label>
                                                                    <input name="scanned_document7" id="scanned_document7"
                                                                        type="file" class="form-control form-control-solid"
                                                                        placeholder="Name" />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="card-toolbar">
                                                            <ul class="nav nav-light-danger nav-bold nav-pills">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a id="note_nav_item" class="nav-link" data-toggle="tab"
