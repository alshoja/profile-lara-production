                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input onkeypress="return isNumber(event)"
                                                        onKeyDown="limitText(this,15);" onKeyUp="limitText(this,15);"
                                                        type="text" class="form-control form-control-solid form-control-lg"
                                                        name="uid" placeholder="UID Number" value="{{ $profile->uid }}"
                                                        id="uid" />
                                            ...
                                            {{-- <div class="col-xl-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-control-solid" name="inventory_data"
                                                        id="inventory_data">{{ $profile->inventory_data }}</textarea>
