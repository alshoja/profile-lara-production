					...
					<div class="d-flex">
						...
						<div class="flex-grow-1">
							...
							<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
								...
								<div class="mr-3">
									<!--begin::Name-->
									<a href="profile-detail.php" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">Jason Muller
								...
								<div class="my-lg-0 my-1">
									<a href="profile-detail.php" class="btn btn-sm btn-success font-weight-bolder text-uppercase">Show More</a>
								</div>
								<!--end::Actions-->
							</div>
							<!--end::Title-->
